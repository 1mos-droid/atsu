...
function readJsonData() {
  try {
    if (fs.existsSync(jsonFilePath)) {
      ...
      console.warn("agent.json not found, creating new file.");
...
function writeJsonData(data) {
  try {
    ...
    console.log("Data saved successfully to agent.json");
  } catch (err) {
    console.error("Failed to save data:", err);
  }
}

// --- Force root route to always load login.html ---
app.get("/", (req, res) => {
...
app.post("/api/agents", (req, res) => {
  console.log("Received new agent data:", req.body);
